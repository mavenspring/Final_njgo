...
public class MessageController {
	...
	public void messageView(int m_num,String category ,Model model,HttpSession session){
	...
	@RequestMapping(value="messageSend",method=RequestMethod.POST)
	   public String messageSend(MessageDTO messageDTO , @RequestParam(required=false) Integer recipeNum){
	      
	      String recipe ="";
	      String reportMessage =messageDTO.getContents();
	      if(messageDTO.getCategory().equals("report")){
	         
	         recipe="<hr><a href='../../recipe/recipeView?num="+recipeNum+"'> 신고레시피 이동 </a><br>";
	         messageDTO.setContents(reportMessage+recipe);
	      }
