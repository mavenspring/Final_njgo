...
public class MyPageController {
	...
	public String myPage(@RequestParam String nickName, @RequestParam(defaultValue="1") String status, HttpSession session , Model model)throws Exception{
		...
		model.addAttribute("followerCount", followerCount).addAttribute("status", status);
