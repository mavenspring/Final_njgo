...
public class QnaController {
	...
	public void qnaList(Model model, @RequestParam(defaultValue="1") Integer curPage, ListInfo listInfo) throws Exception{
		...
		model.addAttribute("nickName", "t5");
	}
	...
	public String qnaReply(Integer num, Model model) throws Exception{
		QnaDTO qnaDTO = qnaService.qnaView(num);
	...
	public String qnaReply(QnaDTO qnaDTO,  RedirectAttributes rd) throws Exception{
