...
public class MemberDAO {
	...
	public int pointPlusUpdate(MemberDTO memberDTO) {

		return sqlSession.update(NAMESPACE+"pointPlusUpdate",memberDTO);
	}
	public int pointMinusUpdate(MemberDTO memberDTO) {

		return sqlSession.update(NAMESPACE+"pointMinusUpdate",memberDTO);
	}
