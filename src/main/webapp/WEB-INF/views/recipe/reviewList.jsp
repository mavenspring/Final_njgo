...
<div id=pagearea>
	...
	<div id=inputarea>
		<input style="margin-top: 10px" type="text" name="contents" id="reply_contents">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input style="margin-top: 10px" type=button id=reply_btn class="btn btn-warning" value="등록">
	</div>
...
<script>
	$('#ratings').on("mouseenter", "img", function(){
		...
		for(i=0;i<$(this).attr('title');i++){
			njgo_off[i].src="../resources/images/kdk/fridge (1).png";
		}
