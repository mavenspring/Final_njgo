...
<script type="text/javascript">
	...
	$(function() {
		...
		$(document).on("change", ".upload_step", function() {
			...
			if( $(".upload_step").val() == '' ) {
				$(this).prevAll("input[type=button]").css("background-image","url('../resources/images/psy/pic_none2.gif')");
			}
		});
...
<body>
	...
	<!-- Modal -->
	<div class="modal_section" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">재료 한 번에 넣기</h4>
				</div>
