...
<body>
	...
	<section class="main_section">
      ...
      <div class="container">
         ...
         <form id="frm" action="${pageContext.request.contextPath}/qna/qna${path}" method="post">
            <input type="hidden" name="writer" value="${memberDTO.nickName}"><!-- 이부분, 생각이 필요함 -->
            <c:if test="${path eq 'Update'}">
           		<input type="hidden" name="num" value="${dto.num}">
           	</c:if> 
           	<c:if test="${path eq 'Reply'}">
            	<input type="hidden" name="ref" value="${qnaDTO.ref}">
            	<input type="hidden" name="step" value="${qnaDTO.step}">
            ...
            <div class="form-group">
               ...
               <input type="text" name="title" value="${dto.title}" class="form-control" id="title" style=" display: inline; width: 87.5%; margin-left: 10px;" placeholder="게시글 제목을 입력하세요.">
            </div>
