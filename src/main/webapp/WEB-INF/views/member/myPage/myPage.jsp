...
<script type="text/javascript">
 ...
 <style>
	...
	.paging_sy .first, .paging_sy .next {
		margin-right: -4px;
	}
	...
	.numbering strong {
		color: #4c4c4c;
		background: url(../../resources/images/csy/numbering_line.gif) no-repeat right 2px;
		padding: 0 9px 0 5px;
	}
		...
		<div id="container">
			...
			<div id="content">
				<section class="sec_mypage">
							      ...
							      <div class="modal-dialog" style="width:570px">
							        <div class="modal-content" style="padding:0;">
							          ...
							          <div class="modal-body" style="padding:10px;text-align:center;">
							            ...
							            <!-- form  -->
							            <form action="profile_upload" method="post" enctype="multipart/form-data" name="uploadFrm">
					...
					<div class="tab_st1">
						<div class="inner">
							...
							<c:if test="${myPage.grade < 2 }">
								<ul>
									<li class="off"><a role="button" onclick="myRecipeList();" class="myRecipe"> <strong>마이레시피</strong><em></em>
									</a></li>
									<li><a role="button" onclick="scrapList();"> <strong>스크랩</strong><em></em>
									</a></li>
									<li><a role="button" onclick="followingList()"> <strong>팔로잉</strong><em>${followerCount }</em>
									</a></li>
									<c:if test="${myPage.nickName eq memberDTO.nickName }">
											<li><a role="button" onclick="messageList()" class="msgList" > <strong>쪽지함</strong><em></em></a>
												<img alt="" src="${pageContext.request.contextPath}/resources/images/csy/new2.png" style="position: absolute; margin-top: 13px; margin-left: -80px; display: none;" class="newImg">
											</li>
										<li><a class="orderList"> <strong>주문내역</strong><em></em>
									</a></li>
									</c:if>
								</ul>	
							</c:if>
					...
					<!-- =============================================== 쪽지 Message  ==================================================  -->
					<div class="scrollmenu"  id="message" style="display:none ;margin-left: 470px; width: 50%;text-align: center; background-color: white">
					  <a role="button" onclick="messageList(1,'general')"><strong>받은 쪽지함</strong></a>|
					  <a role="button" onclick="messageList(1,'send')"><strong>보낸 쪽지함</strong></a>|
...
<script type="text/javascript">
	...
	function myRecipeList(){
		...
		$.ajax({
			url:"/finalProject/recipe/writersearch",
			type:"GET",
			data:{
				writer:'${myPage.nickName}'
			},
			success:function(data){
				$('.in_mypage').html(data.trim());
			}
		});
	}
	function scrapList(){
		...
		$.ajax({
			url:"/finalProject/recipe/scrapsearch",
			type:"GET",
			data:{
	...
	$(".orderList").click(function() {
		...
		$.ajax({
			...
			success: function(data) {
				$("#message").css("display","none");
				$(".inner ul li:nth-child(n)").removeClass("on");
				$(".inner ul li:nth-child(5)").addClass("on");
				$(".in_mypage").html(data);
			}
		});
	});
